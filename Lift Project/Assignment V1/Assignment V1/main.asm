...
//CONVERT_TO_ASCII-OLD
//- parameters input_value, output r25:r24 = ascii val


convert_to_ascii_old:
;prologue
    push arg1
    push temp1
    clr r24
...
start:
	ldi XL, low(ASCII_Value)
	ldi XH, high(ASCII_Value)
...
end_divide:
	...
	st X+, r7 //stor ASCII val in next part of data memory
